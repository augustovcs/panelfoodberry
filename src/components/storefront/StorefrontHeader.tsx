  ...
  return (
    <section className="relative">
      ...
      <div className="mx-auto max-w-[1400px] px-4 lg:px-8">
        <div className="shadow-soft relative -mt-16 rounded-[28px] border border-border/60 bg-card p-5 lg:-mt-20 lg:flex lg:items-end lg:justify-between lg:gap-10 lg:p-7">
          <div className="lg:flex-1">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2">
              ...
              <Pill icon={<ShoppingBag className="h-4 w-4 text-primary" />}>
          ...
          <div className="relative mt-5 lg:mt-0 lg:w-[380px] lg:shrink-0">

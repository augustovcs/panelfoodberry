...
// CSP restritiva. 'unsafe-inline' em script/style é o compromisso pragmático do
// App Router sem nonce (mantém o cardápio estático). 'unsafe-eval' só em dev (HMR).
// Ver ARCHITECTURE.md §9.3.
const csp = [
  "default-src 'self'",
  "base-uri 'self'",
  "form-action 'self'",
